...
AGENT_REGISTRY: dict[str, dict] = {
    ...
    "2200": {
        ...
        "agent_config": {
            ...
            "block_name_patterns": ["DOOR_FRONT", "FRONT_DOOR", "DR_FRONT", "ENTRY_DOOR"],
            "unit": "EA",
        },
    },
    "2300": {
    ...
    "3600": {
        ...
        "agent_config": {
            ...
            "block_name_patterns": [
                "BATH_FULL", "BATH_HALF", "TOILET", "SINK",
                "TUB", "SHOWER", "WH", "HOSE_BIB",
                "LAVATORY", "LAV", "WC", "HB",
            ],
            "unit": "Fix",
        },
    ...
    "4000": {
        ...
        "agent_config": {
            ...
            "block_name_patterns": [
                "FRIDGE", "REFRIGERATOR", "RANGE", "DISHWASHER",
                "OVEN", "MICROWAVE", "WASHER", "DRYER", "HOOD",
            ],
            "unit": "EA",
        },
    },
